        ...
        >
          <div className="container">
            <div className="search-row">
              ...
              {!isSticky && (
                <div className="view-toggle group-toggle desktop-view-toggle">
                  <button 
            ...
            {isSticky ? (
              ...
              <div className="compact-sticky-nav">
                <h2 className="active-category-title">{getActiveCategoryName()}</h2>
